        ...
        if pokemon[0] ~= "None" then
            for I=0,5 do
                ...
                if pokemon[I] ~= "None" and pokemon[I] ~= "0" and pokemon[I] ~= nil then
                    if pokemonExists(pokemon[I]) == false then pokemon[I] = previousPokemon[I];break; else previousPokemon[I] = pokemon[I] end
                    ...
                    --local spritePath = "C:/Users/tammi/Documents/GitHub/PokeStats"
                    local spritePath = ""
                    if tonumber(pokemonGender[I])==2 and love.filesystem.exists('/sprites/'..pokemon[I]..'-f.png') then
                        ...
                        if love.filesystem.exists('/sprites/'..pokemon[I]..'.png') then
                            if tonumber(pokemonIsShiny[I]) == 1 and shinyDisplayStyle ~= 1 then
                            ...
                            pokemonIMG[I] = love.graphics.newImage('/sprites/None.png')
                        end           
                    end
                else
                    pokemonNickname[I] = ""
